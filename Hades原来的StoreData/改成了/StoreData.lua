...
BrokerData = 
{
	...
	{ 
		BuyName = "LockKeys", BuyAmount = 100,
		CostName = "Gems", CostAmount = 0, 
		OfferName = "MarketScreen_LockKeys",
		Priority = true, 
		PurchaseSound = "/SFX/KeyPickup",
	},

	{ 
		BuyName = "GiftPoints", BuyAmount = 100,
	...
	{ 
		BuyName = "SuperGems", BuyAmount = 10,
		CostName = "GiftPoints", CostAmount = 0, 
		Priority = true,
	...
	{ 
		BuyName = "SuperGiftPoints", BuyAmount = 10,
		CostName = "SuperGems", CostAmount = 0, 
		Priority = true,
	...
	{ 
		BuyName = "SuperLockKeys", BuyAmount = 10,
		CostName = "SuperGiftPoints", CostAmount = 0, 
		Priority = true, 
	...
	{ 
		BuyName = "GiftPoints", BuyAmount = 1000,
		CostName = "Gems", CostAmount = 0, 
		PurchaseSound = "/SFX/GiftAmbrosiaBottlePickup",
	},

	{ 
		BuyName = "LockKeys", BuyAmount = 3000,
		CostName = "MetaPoints", CostAmount = 0, 
		PurchaseSound = "/SFX/KeyPickup",
	},

	{ 
		BuyName = "MetaPoints", BuyAmount = 1000000,
		CostName = "GiftPoints", CostAmount = 0, 
		PurchaseSound = "/SFX/Player Sounds/DarknessCollectionPickup",
	},

	{ 
		BuyName = "Gems", BuyAmount = 100000,
		CostName = "LockKeys", CostAmount = 0, 
		PurchaseSound = "/SFX/GemPickup",
	},

	{ 
		BuyName = "SuperLockKeys", BuyAmount = 100,
		CostName = "LockKeys", CostAmount = 0, 
		PurchaseSound = "/SFX/TitanBloodPickupSFX",
	...
	{ 
		BuyName = "Gems", BuyAmount = 100000,
		CostName = "SuperLockKeys", CostAmount = 0, 
		PurchaseSound = "/SFX/GemPickup",
		GameStateRequirements = { RequiredKills = { Harpy = 1 }, },
	},

	{ 
		BuyName = "SuperGiftPoints", BuyAmount = 1000,
		CostName = "GiftPoints", CostAmount = 0, 
		PurchaseSound = "/SFX/SuperGiftAmbrosiaBottlePickup",
		GameStateRequirements = { RequiredKills = { Theseus = 1 }, },
	},
	...
	{ 
		BuyName = "SuperGems", BuyAmount = 1000,
		CostName = "SuperLockKeys", CostAmount = 0, 
		PurchaseSound = "/SFX/SuperGemPickup",
		GameStateRequirements = { RequiredKills = { Hades = 1 }, },
	},
